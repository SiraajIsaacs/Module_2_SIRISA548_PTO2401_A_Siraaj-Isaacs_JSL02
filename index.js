...
// Array to store the goals entered in order to check values entered to prevent duplicates.
const goals = [];

const addNewGoal = () => {
    const goalInput = document.querySelector('#goalInput').value;
    const goalList = document.querySelector('#goalList');
    // Includes function checks if the goalInput value is already stored in the array and logs the alert out.
    if(goalInput == '') {
        alert('You must enter a goal!');
    } else if(goals.includes(goalInput)) {
